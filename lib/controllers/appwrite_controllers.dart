...
const String db = "66605721000dbb12d21c";
const String userCollection = "66605731001de8cb1eb5";
const String chatCollection = "666070230021d9ee0827";
const String storageBucket = "66605d0600130a8db708";
...
Future<DocumentList?> searchUsersNumber(
...
// to search all the users from the database
Future<DocumentList?> searchUsersName(
    {required String searchItem, required String userId}) async {
  try {
    final DocumentList users = await databases.listDocuments(
        databaseId: db,
...
Future sendNotificationtoOtherUser({
  ...
  try {
    ...
    final response = await http.post(
        Uri.parse("https://666474e8cf3999614cf6.appwrite.global/"),
